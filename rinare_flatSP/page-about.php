			...
			<div class="post">
				<article>
					...
					<div class="entryBody">
						...
						中には、登場回数1.5回（しかも超初期に）しかないのに読者さんから絶大な人気をほこるジョージ（仮名）なんてのもいます。でも、途中からApple Storeでのエピソードはブログには書きづらくなっちゃいましたね。ブログの読者さんが増えるのは嬉しいですし、反響があるのも嬉しいことなんですが…。このあたりはブログを書いている人は一度は悩むところかもしれません。まだまだ続くよ！次は主要人物とりんあれのブログ歴など！↓</p>
